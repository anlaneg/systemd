...
int config_item_table_lookup(
                ...
                ConfigParserCallback *ret_func/*出参，右值解析填充函数*/,
                int *ret_ltype/*出参，左值（key)的类型*/,
                void **ret_data/*出参，关联的data*/,
                void *userdata) {
...
int config_item_perf_lookup(
                ...
                ConfigParserCallback *ret_func/*出参，解析此key value的函数指针*/,
                int *ret_ltype/*出参，此key value的类型*/,
                void **ret_data/*出参，解析key value要填充的userdata中对应的填充参数*/,
